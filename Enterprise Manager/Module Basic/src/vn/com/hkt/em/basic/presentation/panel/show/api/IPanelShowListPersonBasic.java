...
/**
 *Mặt nạ gia diện hiển thị danh sách thông tin cơ bản của cá nhân
 * @author BinLe
 */
public interface IPanelShowListPersonBasic extends IPanelShowListInformation {
     ...
     * @return 
     */
    public long getLevelPanelShowListPersonBasic();
}
